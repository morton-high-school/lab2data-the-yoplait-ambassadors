public class LinearRegression
{
    ...
    public setSlope(ArrayList<YearData> data)
    {
        this.data = data;
        n = data.size();
    ...
    public setYIntercept(ArrayList<YearData> data)
    {
        this.data = data;
        n = data.size();
    ...
    {
        setSlope(data);// I do not think I called the methods correctly here...is this right?
        setYIntercept(data);
